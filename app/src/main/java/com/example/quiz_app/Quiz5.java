...
public class Quiz5 extends AppCompatActivity {
    ...
    private boolean hasStarted = false; // Variable pour contrôler si l'application a démarré
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timerTextView = findViewById(R.id.timerTextView); // Lien avec TextView pour le timer

        Intent intent = getIntent();
        score = intent.getIntExtra("score", 0);

        // Initialisation PreviewView et caméra
        previewView = findViewById(R.id.previewView);
        cameraExecutor = Executors.newSingleThreadExecutor();
        startCamera();

        // Démarrage du timer de 30 secondes
        startTimer();

        bNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Annule le timer quand l'utilisateur clique sur "Suivant"
    ...
    private void startTimer() {
        new CountDownTimer(30000, 1000) { // 30 secondes, 1 tick par seconde
            @Override
            ...
            public void onFinish() {
                ...
                // Vous pouvez ici forcer l'utilisateur à passer à l'écran suivant ou finir le quiz
    ...
    private void startCamera() {
        ...
        cameraProviderFuture.addListener(() -> {
            try {
                ...
                Log.e("Quiz5", "Erreur configuration caméra", e);
            }
